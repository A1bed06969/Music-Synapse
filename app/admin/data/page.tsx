    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="flex items-baseline justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/admin/data/artists/images" className="text-xs text-white/40 hover:text-white/70">
            アーティスト画像を一括更新
          </Link>
      ...
      <section className="mt-10 border-t border-white/10 pt-8">
        <div className="flex items-baseline justify-between">
          <h2 className="text-lg font-semibold">アワード</h2>
          <Link href="/chronology/awards" className="text-xs text-white/40 hover:text-white/70">
            公開ページを見る →
          </Link>
        </div>

        <form action={createAward} className="mt-4 flex flex-wrap gap-2">
