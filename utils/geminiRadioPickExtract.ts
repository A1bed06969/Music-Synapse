...
- ページによっては「2026年9月」「2026年8月」のように、今月分だけでなく
  過去何ヶ月分ものバックナンバーが1ページにまとめて掲載されていることがある。
  この場合、一番新しい月(通常はページの先頭に近い方)の分だけを対象とし、
  それより古い月の分は含めないこと。月や日付の表記が無く単発の情報しか
  無いページであれば、書かれているものをそのまま対象としてよい
